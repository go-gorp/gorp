...
// Query Parameters
//
// Gorp's Exec, Select*, Query, and QueryRow methods accept placeholder
// parameters in the query, to be filled from the args parameters to these
// functions. Gorp supports some additional styles for placeholder parameters:
//
// Named Bind Parameters
//
// For the Exec and Select* methods on DbMap and Transaction, Gorp supports
...
// Before running the query, Gorp will bind each named placeholder parameter to the
...
// slices will be handled specially. Gorp will modify the query, adding more
